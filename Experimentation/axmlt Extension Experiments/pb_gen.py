...
class generator:
    ...
    def createConstantRules(self):    
        ...
        for x in range(self.n_con_rules):
            ...
            vr = "2{grant(" + rand_var_type1[0] + "," + rand_var_type1[1] + "," + rand_var_type1[2] + "), grant(" + rand_var_type4[0] + "," + rand_var_type4[1] + "," + rand_var_type4[2] + "), grant(" + rand_var_type5[0] + "," + rand_var_type5[1] + "," + rand_var_type5[2] + "), grant(" + rand_var_type6[0] + "," + rand_var_type6[1] + "," + rand_var_type6[2] + ")}2"
            vr += ":-"
